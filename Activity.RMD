...
Downloaded dataset activity.csv is unzip and placed  in WD.
...
Group the number of steps by date and intervals. Find the total number of steps per day over all days.
